    ...
    def forward(self, bipartites):
        if isinstance(bipartites, dgl.DGLGraph):
            ...
            if self.use_cluster_feat:
                ...
                print('Shape of feature: ', bipartites[0].ndata['features'].shape)
                print('Shape of concatenate feature: ', neighbor_x.shape)
            else:
            ...
            print('Output bipartite feature: ', output_bipartite.shape)
        else:
            if self.use_cluster_feat:

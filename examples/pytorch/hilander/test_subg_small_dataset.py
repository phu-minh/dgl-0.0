...
for level in range(args.levels):
    ...
    new_pred_labels, peaks, global_edges, global_pred_labels, global_peaks = decode(g, args.tau, args.threshold, args.use_gt,
...
print(dt_string,file=open('output_small.txt', 'a'))
print('Test on:' + args.data_path,file=open('output_small.txt', 'a'))
print('Clustering with k={},level={}'.format(args.knn_k,args.levels),file=open('output_small.txt', 'a'))
evaluation(global_pred_labels, global_labels, args.metrics,'output_small.txt')
